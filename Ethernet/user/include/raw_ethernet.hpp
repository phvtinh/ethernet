...
namespace user_ethernet {
  ...
  public:
    ethernet ();
	ethernet (const std::string & ifname, uint16_t protocol);
    ~ethernet ();
    /*! 
	 * \ define the size of ethernet packet base on standard Eth II, IEEE 802.3 
	 * \ https://en.wikipedia.org/wiki/Ethernet_frame
	 */
    static const int MAX_PKTLEN = 1522;
